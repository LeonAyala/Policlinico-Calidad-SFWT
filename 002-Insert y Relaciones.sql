...
INSERT INTO rol(Descripcion) VALUES ('ADMINISTRADOR'),('ASISTENTE'),('MEDICO'),('PACIENTE')
...
INSERT [dbo].[Menu] ([idMenu], [nombre], [isSubmenu], [url], [idMenuParent], [estado], [show], [orden]) VALUES (2, N'Matenimiento', 0, N'', NULL, 1, 1, 7)
INSERT [dbo].[Menu] ([idMenu], [nombre], [isSubmenu], [url], [idMenuParent], [estado], [show], [orden]) VALUES (3, N'Registro de Pacientes', 1, N'frmGPaciente.aspx', 2, 1, 1, 7)
INSERT [dbo].[Menu] ([idMenu], [nombre], [isSubmenu], [url], [idMenuParent], [estado], [show], [orden]) VALUES (4, N'Registro de Medicos', 1, N'frmGMedico.aspx', 2, 1, 1, 7)
INSERT [dbo].[Menu] ([idMenu], [nombre], [isSubmenu], [url], [idMenuParent], [estado], [show], [orden]) VALUES (5, N'Registro de Especialidad', 1, N'frmGEspecialidad.aspx', 2, 1, 1, 7)
INSERT [dbo].[Menu] ([idMenu], [nombre], [isSubmenu], [url], [idMenuParent], [estado], [show], [orden]) VALUES (6, N'Registro de Usuarios', 1, N'frmGUsuario.aspx', 2, 1, 1, 7)
INSERT [dbo].[Menu] ([idMenu], [nombre], [isSubmenu], [url], [idMenuParent], [estado], [show], [orden]) VALUES (7, N'Reserva de Citas', 0, N'frmGReservaCitas.aspx', NULL, 1, 1, 7)
INSERT [dbo].[Menu] ([idMenu], [nombre], [isSubmenu], [url], [idMenuParent], [estado], [show], [orden]) VALUES (8, N'Atención de Citas', 0, N'frmGAtencionPaciente.aspx', NULL, 1, 1, 7)
INSERT [dbo].[Menu] ([idMenu], [nombre], [isSubmenu], [url], [idMenuParent], [estado], [show], [orden]) VALUES (9, N'Horarios', 0, N'', NULL, 1, 1, 7)
INSERT [dbo].[Menu] ([idMenu], [nombre], [isSubmenu], [url], [idMenuParent], [estado], [show], [orden]) VALUES (10, N'Horarios Medicos', 1, N'frmGHorarioAtencion.aspx', 9, 1, 1, 7)
INSERT [dbo].[Menu] ([idMenu], [nombre], [isSubmenu], [url], [idMenuParent], [estado], [show], [orden]) VALUES (12, N'Gestionar Menus', 0, N'frmGMenus.aspx', NULL, 1, 1, 7)
INSERT [dbo].[Menu] ([idMenu], [nombre], [isSubmenu], [url], [idMenuParent], [estado], [show], [orden]) VALUES (13, N'Administrar Permisos', 0, N'frmGPermisos.aspx', NULL, 1, 1, 7)
...
--INSERT INTO sede (Nombre,Ruc,Direccion,Telefono) VALUES
--('Policlinico 01','1042526321','Av. Copacabana S/N - Puente Piedra ', '5485261'),
--('Policlinico 02','1541525262', 'Av. Palmeras n° 254 - Los Olivos','5325425');
...
INSERT [dbo].[Empleado] ([idEmpleado], [nombres], [apPaterno], [apMaterno], [nroDocumento],[telefono],[correo], [estado], [imagen]) VALUES (1, N'Juan Carlos', N'Farias', N'Villegas', N'87653021',974128251,'prueba1@gmail.com', 1, NULL)
INSERT [dbo].[Empleado] ([idEmpleado], [nombres], [apPaterno], [apMaterno], [nroDocumento],[telefono],[correo], [estado], [imagen]) VALUES (2, N'Rosa Maria', N'Flores', N'Linares', N'78650932',912521452,'prueba2@gmail.com', 1, NULL)
INSERT [dbo].[Empleado] ([idEmpleado], [nombres], [apPaterno], [apMaterno], [nroDocumento],[telefono],[correo], [estado], [imagen]) VALUES (3, N'Carlos Jose', N'Romero', N'Alfaro', N'70983262',954256214,'prueba3@gmail.com', 1, NULL)
INSERT [dbo].[Empleado] ([idEmpleado], [nombres], [apPaterno], [apMaterno], [nroDocumento],[telefono],[correo], [estado], [imagen]) VALUES (4, N'Juan José', N'Pérez', N'Carrión', N'70874378',954528541,'prueba4@gmail.com', 1, NULL)
...
--
--REGISTROS USUARIO
insert into usuario(NUsuario,Clave,IdRol,idEmpleado)
values('Admin','Admin123',(select TOP 1 IdRol from rol where Descripcion = 'ADMINISTRADOR'),1)
go
insert into usuario(NUsuario,Clave,IdRol,idEmpleado)
values('Asistente','Asistente123',(select TOP 1 IdRol from rol where Descripcion = 'ASISTENTE'),2)
go
insert into usuario(NUsuario,Clave,IdRol,idEmpleado)
values('Medico','Medico123',(select TOP 1 IdRol from rol where Descripcion = 'MEDICO'),3)
go
insert into usuario(NUsuario,Clave,IdRol,idEmpleado)
values('Paciente','Paciente123',(select TOP 1 IdRol from rol where Descripcion = 'PACIENTE'),4)
GO
...
INSERT [dbo].[Medico] ([idMedico], [Titulo],[Cargo],[CMP],[idEmpleado], [idEspecialidad],[estado]) VALUES (1, 'UNIVERSIDAD CAYETANO HEREDIA','Médico Especialista',83699,1, 1, 1)
...
INSERT [dbo].[Paciente] ([idPaciente], [nombres], [apPaterno], [apMaterno], [edad], [sexo], [nroDocumento], [direccion], [telefono],[correo], [estado], [imagen],[nusuario],[clave]) VALUES (1, N'Jorge', N'Perez', N'Carrión', 21, N'Masculino', N'17885200', N'Cale Prueba #854', N'99552047','prueba@gmail.com', 1, NULL,'Prueba','Prueba123')
INSERT [dbo].[Paciente] ([idPaciente], [nombres], [apPaterno], [apMaterno], [edad], [sexo], [nroDocumento], [direccion], [telefono],[correo], [estado], [imagen],[nusuario],[clave]) VALUES (2, N'Sandra', N'Sanchez', N'Moreno', 20, N'Femenino', N'87690987', N'Cale Prueba #854', N'85452222','prueba@gmail.com', 1, NULL,'Prueba','Prueba123')
INSERT [dbo].[Paciente] ([idPaciente], [nombres], [apPaterno], [apMaterno], [edad], [sexo], [nroDocumento], [direccion], [telefono],[correo], [estado], [imagen],[nusuario],[clave]) VALUES (3, N'Francisco', N'Pereda', N'Sandoval', 32, N'Masculino', N'70981274', N'Cale Prueba #854', N'87542221','prueba@gmail.com', 1, NULL,'Prueba','Prueba123')
INSERT [dbo].[Paciente] ([idPaciente], [nombres], [apPaterno], [apMaterno], [edad], [sexo], [nroDocumento], [direccion], [telefono],[correo], [estado], [imagen],[nusuario],[clave]) VALUES (4, N'Javier Estefano', N'Sanchez', N'Martinez', 28, N'Masculino', N'56743409', N'Cale Prueba #854', N'285746','prueba@gmail.com', 1, NULL,'Prueba','Prueba123')
INSERT [dbo].[Paciente] ([idPaciente], [nombres], [apPaterno], [apMaterno], [edad], [sexo], [nroDocumento], [direccion], [telefono],[correo], [estado], [imagen],[nusuario],[clave]) VALUES (5, N'Cesar Javier', N'Vasquez', N'Leon', 30, N'Masculino', N'46783254', N'Cale Prueba #854', N'245684','prueba@gmail.com', 1, NULL,'Prueba','Prueba123')
INSERT [dbo].[Paciente] ([idPaciente], [nombres], [apPaterno], [apMaterno], [edad], [sexo], [nroDocumento], [direccion], [telefono],[correo], [estado], [imagen],[nusuario],[clave]) VALUES (6, N'Maria Isabel', N'Farias', N'Tirado', 25, N'Femenino', N'24236789', N'Cale Prueba #854', N'346778','prueba@gmail.com', 1, NULL,'Prueba','Prueba123')
INSERT [dbo].[Paciente] ([idPaciente], [nombres], [apPaterno], [apMaterno], [edad], [sexo], [nroDocumento], [direccion], [telefono],[correo], [estado], [imagen],[nusuario],[clave]) VALUES (7, N'Carlos Andres', N'Paredes', N'Sisniegas', 32, N'Masculino', N'76564909', N'Cale Prueba #854', N'95786198','prueba@gmail.com', 0, NULL,'Prueba','Prueba123')
INSERT [dbo].[Paciente] ([idPaciente], [nombres], [apPaterno], [apMaterno], [edad], [sexo], [nroDocumento], [direccion], [telefono],[correo], [estado], [imagen],[nusuario],[clave]) VALUES (9, N'Julia Maria', N'Santoso', N'Morales', 22, N'Femenino', N'99632014', N'Sin dirección', N'625485','prueba@gmail.com', 0, NULL,'Prueba','Prueba123')
INSERT [dbo].[Paciente] ([idPaciente], [nombres], [apPaterno], [apMaterno], [edad], [sexo], [nroDocumento], [direccion], [telefono],[correo], [estado], [imagen],[nusuario],[clave]) VALUES (10, N'Julia Maria', N'Santoso', N'Morales', 21, N'Femenino', N'78541203', N'Sin dirección', N'625485','prueba@gmail.com', 0, NULL,'Prueba','Prueba123')
INSERT [dbo].[Paciente] ([idPaciente], [nombres], [apPaterno], [apMaterno], [edad], [sexo], [nroDocumento], [direccion], [telefono],[correo], [estado], [imagen],[nusuario],[clave]) VALUES (11, N'Julia Maria', N'Santoso', N'Morales', 25, N'Femenino', N'78541203', N'Sin dirección', N'625485','prueba@gmail.com', 1, NULL,'Prueba','Prueba123')
INSERT [dbo].[Paciente] ([idPaciente], [nombres], [apPaterno], [apMaterno], [edad], [sexo], [nroDocumento], [direccion], [telefono],[correo], [estado], [imagen],[nusuario],[clave]) VALUES (12, N'JJJ RRR', N'RR', N'CC', 23, N'Masculino', N'3456789', N'Sin dirección', N'625485','prueba@gmail.com', 0, NULL,'Prueba','Prueba123')
INSERT [dbo].[Paciente] ([idPaciente], [nombres], [apPaterno], [apMaterno], [edad], [sexo], [nroDocumento], [direccion], [telefono],[correo], [estado], [imagen],[nusuario],[clave]) VALUES (13, N'24', N'2', N'24', 24, N'Masculino', N'2324', N'234', N'24','prueba@gmail.com', 0, NULL,'Prueba','Prueba123')
INSERT [dbo].[Paciente] ([idPaciente], [nombres], [apPaterno], [apMaterno], [edad], [sexo], [nroDocumento], [direccion], [telefono],[correo], [estado], [imagen],[nusuario],[clave]) VALUES (14, N'24', N'2', N'24', 24, N'Masculino', N'2324', N'234', N'24','prueba@gmail.com', 0, NULL,'Prueba','Prueba123')
INSERT [dbo].[Paciente] ([idPaciente], [nombres], [apPaterno], [apMaterno], [edad], [sexo], [nroDocumento], [direccion], [telefono],[correo], [estado], [imagen],[nusuario],[clave]) VALUES (15, N'2434234', N'24243 2342', N'234', 24324, N'Masculino', N'34','prueba@gmail.com', N'23424', N'242', 0, NULL,'Prueba','Prueba123')
INSERT [dbo].[Paciente] ([idPaciente], [nombres], [apPaterno], [apMaterno], [edad], [sexo], [nroDocumento], [direccion], [telefono],[correo], [estado], [imagen],[nusuario],[clave]) VALUES (16, N'sdsffsfs', N'Rodriguez', N'Morales', 22, N'Masculino', N'78541203', N'Calle 128 ', N'96520140','prueba@gmail.com', 0, NULL,'Prueba','Prueba123')
SET IDENTITY_INSERT [dbo].[Paciente] OFF
go

-- PARA RESERVA DE CITAS
...
GO
INSERT INTO HoraInicio (hora) VALUES
('08:00'),
('08:30'),
('09:00'),
('09:30'),
...
--
GO
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 1, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 2, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 3, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 4, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 5, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 6, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 7, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 8, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 9, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 10, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 11, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 12, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 13, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 14, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 15, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 16, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 17, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 1011, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 1012, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 1013, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 1015, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (1, 1016, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (2, 1, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (2, 2, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (2, 3, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (2, 6, 1)
INSERT [dbo].[Permisos] ([IdUsuario], [idMenu], [estado]) VALUES (2, 1014, 1)
--
go

INSERT [dbo].[notificacion] ( [descripcion]) VALUES ('Su cita esta Programada, debe asistir en la hora puntual')
INSERT [dbo].[notificacion] ( [descripcion]) VALUES ('Su cita esta por Vencer, no se olvide de asistir en la hora programada')
INSERT [dbo].[notificacion] ( [descripcion]) VALUES ('Su cita Fue Cancelada, por no asistir en la hora indicada')
INSERT [dbo].[notificacion] ( [descripcion]) VALUES ('Su Cita Finalizo con Exito, gracias por su asistencia puntual')
INSERT [dbo].[notificacion] ( [descripcion]) VALUES ('Su Cita es dentro de 30 Minutos, se le recuerda que falta poco para su atención')
-- Volcado de datos para la tabla cita
GO
SET IDENTITY_INSERT [dbo].[Cita] ON 
INSERT [dbo].[Cita] ([idCita],[idMedico], [idPaciente], [fechaReserva], [observacion], [estado], [hora]) VALUES (1,1, 1, CAST(N'2022-02-12 00:00:00.000' AS DateTime), N'', N'A', N'20:00')
INSERT [dbo].[Cita] ([idCita],[idMedico], [idPaciente], [fechaReserva], [observacion], [estado], [hora]) VALUES (2,1, 2, CAST(N'2022-02-12 00:00:00.000' AS DateTime), N'', N'A', N'10:00')
INSERT [dbo].[Cita] ([idCita],[idMedico], [idPaciente], [fechaReserva], [observacion], [estado], [hora]) VALUES (3,1, 1, CAST(N'2022-02-12 00:00:00.000' AS DateTime), N'', N'A', N'11:00')
INSERT [dbo].[Cita] ([idCita],[idMedico], [idPaciente], [fechaReserva], [observacion], [estado], [hora]) VALUES (4,1, 3, CAST(N'2022-02-12 00:00:00.000' AS DateTime), N'', N'A', N'17:30')
SET IDENTITY_INSERT [dbo].[Cita] OFF
GO

SET IDENTITY_INSERT [dbo].[HorarioAtencion] ON 
INSERT [dbo].[HorarioAtencion] ([idHorarioAtencion], [idMedico], [idHoraInicio], [fecha], [fechaFin], [estado], [idDiaSemana]) VALUES (1, 1, 10, CAST(N'2021-11-12 00:00:00.000' AS DateTime), NULL, 1, NULL)
INSERT [dbo].[HorarioAtencion] ([idHorarioAtencion], [idMedico], [idHoraInicio], [fecha], [fechaFin], [estado], [idDiaSemana]) VALUES (2, 1, 13, CAST(N'2021-11-12 00:00:00.000' AS DateTime), NULL, 0, NULL)
INSERT [dbo].[HorarioAtencion] ([idHorarioAtencion], [idMedico], [idHoraInicio], [fecha], [fechaFin], [estado], [idDiaSemana]) VALUES (3, 1, 1, CAST(N'2021-11-15 00:00:00.000' AS DateTime), NULL, 0, NULL)
INSERT [dbo].[HorarioAtencion] ([idHorarioAtencion], [idMedico], [idHoraInicio], [fecha], [fechaFin], [estado], [idDiaSemana]) VALUES (4, 1, 5, CAST(N'2021-11-15 00:00:00.000' AS DateTime), NULL, 1, NULL)
INSERT [dbo].[HorarioAtencion] ([idHorarioAtencion], [idMedico], [idHoraInicio], [fecha], [fechaFin], [estado], [idDiaSemana]) VALUES (5, 1, 1, CAST(N'2021-11-15 00:00:00.000' AS DateTime), NULL, 0, NULL)
INSERT [dbo].[HorarioAtencion] ([idHorarioAtencion], [idMedico], [idHoraInicio], [fecha], [fechaFin], [estado], [idDiaSemana]) VALUES (6, 1, 1, CAST(N'2021-11-15 00:00:00.000' AS DateTime), NULL, 0, NULL)
INSERT [dbo].[HorarioAtencion] ([idHorarioAtencion], [idMedico], [idHoraInicio], [fecha], [fechaFin], [estado], [idDiaSemana]) VALUES (7, 1, 2, CAST(N'2021-11-15 00:00:00.000' AS DateTime), NULL, 0, NULL)
INSERT [dbo].[HorarioAtencion] ([idHorarioAtencion], [idMedico], [idHoraInicio], [fecha], [fechaFin], [estado], [idDiaSemana]) VALUES (8, 1, 3, CAST(N'2021-11-15 00:00:00.000' AS DateTime), NULL, 0, NULL)
INSERT [dbo].[HorarioAtencion] ([idHorarioAtencion], [idMedico], [idHoraInicio], [fecha], [fechaFin], [estado], [idDiaSemana]) VALUES (9, 1, 2, CAST(N'2021-11-15 00:00:00.000' AS DateTime), NULL, 1, NULL)
INSERT [dbo].[HorarioAtencion] ([idHorarioAtencion], [idMedico], [idHoraInicio], [fecha], [fechaFin], [estado], [idDiaSemana]) VALUES (10, 1, 3, CAST(N'2021-11-15 00:00:00.000' AS DateTime), NULL, 1, NULL)
INSERT [dbo].[HorarioAtencion] ([idHorarioAtencion], [idMedico], [idHoraInicio], [fecha], [fechaFin], [estado], [idDiaSemana]) VALUES (11, 1, 13, CAST(N'2021-11-15 00:00:00.000' AS DateTime), NULL, 1, NULL)
INSERT [dbo].[HorarioAtencion] ([idHorarioAtencion], [idMedico], [idHoraInicio], [fecha], [fechaFin], [estado], [idDiaSemana]) VALUES (12, 1, 14, CAST(N'2021-11-15 00:00:00.000' AS DateTime), NULL, 1, NULL)
INSERT [dbo].[HorarioAtencion] ([idHorarioAtencion], [idMedico], [idHoraInicio], [fecha], [fechaFin], [estado], [idDiaSemana]) VALUES (13, 1, 15, CAST(N'2021-11-15 00:00:00.000' AS DateTime), NULL, 1, NULL)
INSERT [dbo].[HorarioAtencion] ([idHorarioAtencion], [idMedico], [idHoraInicio], [fecha], [fechaFin], [estado], [idDiaSemana]) VALUES (14, 1, 16, CAST(N'2021-11-15 00:00:00.000' AS DateTime), NULL, 1, NULL)
...
INSERT INTO ubigeo_departamento (id_departamento, name) VALUES
('01', 'Amazonas'),
('02', 'Áncash'),
('03', 'Apurímac'),
('04', 'Arequipa'),
...
INSERT INTO ubigeo_provincia (id_provincia, name, id_departamento) VALUES
('0101', 'Chachapoyas', '01'),
('0102', 'Bagua', '01'),
('0103', 'Bongará', '01'),
...
INSERT INTO ubigeo_distrito (id_distrito, name, id_provincia, id_departamento) VALUES
